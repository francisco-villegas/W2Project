...
public class RecyclerAdapter extends ExpandableRecyclerViewAdapter<TitleViewHolder, SubTitleViewHolder> {
    ...
    @Override
    public void onBindChildViewHolder(final SubTitleViewHolder holder, int flatPosition,
        ...
        holder.setSubtitleImg(context,subTitle.getImg());
        holder.itemView.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                mListener.onChildClick(subTitle.getName());
            }
        });
    }
